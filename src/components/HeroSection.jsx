...
export default function HeroSection() {
  ...
  return (
    <div
      ref={containerRef}
      className="relative bg-black h-screen w-full p-2 text-white overflow-hidden"
    >
      {/* Background Video */}
      {/* <video
                autoPlay
      ...
      <header className="flex justify-between items-center px-6 py-4 md:px-12 z-10">
        <div className="border-2 border-[#FF706A] p-2">
          <span className="text-[#FF706A] font-serif text-xl font-bold px-4">
      ...
      <main className="px-6 md:px-12 pt-4 pb-32 z-10">
        <div className="mb-8">
          <p className="uppercase tracking-wider text-sm font-light mb-1">
            REDEFINING{" "}
            <span className="inline-block w-12 h-px bg-white mx-4"></span>{" "}
            CELEBRATION
          </p>
        </div>
        ...
        <div className="relative mt-64 mb-12">
          <div className="absolute -left-4 w-40 h-32">
            <div className="group relative w-24 h-24 top-10 rounded-full border border-[#FF706A] text-[#FF706A] text-xs flex items-center justify-center overflow-hidden cursor-pointer transition-colors duration-300">
              ...
              <div className="absolute bottom-2 py-2 left-1/2 transform -translate-x-1/2 z-10">
                <svg
                  width="16"
                  height="16"
                  viewBox="0 0 16 16"
                  className="text-[#FF706A] group-hover:text-white transition-colors duration-300"
                >
                  <path
          ...
          {menuItems.map((item, index) => (
            ...
            >
              ...
              <img
                ...
                className="absolute opacity-0 group-hover:opacity-0 transition-opacity duration-500 z-0 w-[50vw]  object-cover rounded-3xl "
              />

              {/* Menu Text */}
              <a
                href="#"
                className="relative z-10 font-[Moranga] text-7xl text-white   transition-all duration-500 group-hover:text-[#fa5a55] "
              >
                {item.title}
              </a>
            </div>
